...
const extWaveqlLangLezerWith = require('./ext-waveql-lang-lezer-with.js');
const extChangeWith = require('./ext-change-with.js');
const waveqlCompletionsWith = require('./waveql-completions-with.js');

const mountCodeMirror6 = (sidebar, deso, pstate, render, extensions) => {
  const sidebarState = EditorState.create({
    ...
    extensions: [
      ...
      extMainTheme,
      extWaveqlLangLezerWith(deso.wires),
